...
from src.compute_modality import compute_and_save_modality
...
parser.add_argument(
    "--dir", help="Directory where the input files are situated (*_0000)"
)
parser.add_argument(
    "--suffix",
...
all_file_names = [
    ...
    if file_name.endswith(ORIGINAL_SUFFIX)
]
