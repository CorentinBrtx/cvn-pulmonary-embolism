...
def compute_threshold_effects(frangi: np.ndarray, ground_truth: np.ndarray, n_thersholds=10, thresholds=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--destination", help="Name of the file to output the plottings of the threshlds effects")
